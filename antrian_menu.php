...
<table class="table-list" width="745" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="45" align="center" bgcolor="#CCCCCC"><b>Validasi Pesanan</b></td>
  </tr>
<?php
...
<?php if ($kolomData['uang_bayar']<$kolom2Data['subtotal']) {
 ?>
    <td align="center"><a href="index.php?page=ValidasiBayar&no_penjualan=<?php echo $kolomData['no_penjualan'];?>&uang=<?php echo $kolom2Data['subtotal'];?>"><img src="images/validasi.png" width="20" height="20" border="0" /></a></td>
<?php } ?>
  </tr>
  <?php } ?>
  <tr>
